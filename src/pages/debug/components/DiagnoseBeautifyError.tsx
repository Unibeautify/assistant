...
export class DiagnoseBeautifyError extends React.Component<DiagnoseBeautifyErrorProps, DiagnoseBeautifyErrorState> {
    ...
    private renderInvalidExecutableVersionError() {
        ...
        return (<div>
            The version of executable "<strong>{error.executable}</strong>" could not be properly parsed from "<strong>{error.version}</strong>".
            If you think this is a bug please report it by clicking <a href={url} target="_blank" className="alert-link">here</a>.
        </div>);
    }
