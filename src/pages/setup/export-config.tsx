...
export class ExportConfig extends React.Component<ExportConfigProps, ExportConfigState> {
        ...
        return (
            <div className="exportConfig">
                ...
                <li className="nav-item">
                    <a className={`nav-link${exportLanguage==="json" ? " active show" : ""}`} onClick={this.handleTabClick} data-toggle="tab" href="#json">JSON</a>
                </li>
                <li className="nav-item">
                    <a className={`nav-link${exportLanguage==="yaml" ? " active show" : ""}`} onClick={this.handleTabClick} data-toggle="tab" href="#yaml">YAML</a>
                </li>
                </ul>
                <CodeMirror
                    value={configText}
